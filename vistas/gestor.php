...
if(isset($_SESSION['usuario'])){
	...
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			<h1 class="display-4">Gestor de Documentos</h1>
			<span class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarArchivos">
				<span class="fas fa-plus-circle"></span> Agregar Documentos/Archivos
			</span>
			<hr>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Agregar Documentos/Archivos</h5>
				...
				<div class="modal-body">
					<form id="frmArchivos" enctype="multipart/form-data">
						...
						<label>Selecciona documetos/archivos</label>
